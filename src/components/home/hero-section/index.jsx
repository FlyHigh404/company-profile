...
export default function HeroSection() {
	return (
	<div className=" px-[20px] md:px-[80px] lg:px-[80px]">
		<div className="flex flex-col items-center justify-center text-center">
			...
			<Image src="/images/hero.png" alt="Hero Background" width={1239.5} height={633.8} />
			</div>
			<div>
				<h1 className="typo-h4 md:typo-h3 lg:typo-h2 pb-6 md:pb-9 lg:pb-8 text-neutral-700 px-[2px] md:px-[50px] lg:px-[250px] cursor-default">Inovasi Teknologi untuk Mobilitas yang Lebih Hijau dan Terintegrasi</h1>
