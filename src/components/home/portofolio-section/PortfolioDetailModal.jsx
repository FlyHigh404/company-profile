...
const techIcons = {
  ...
  TensorFlow: <Image src={tensorflowIcon} alt="TensorFlow" width={32} height={32} />,
  Kotlin: <Image src={kotlinIcon} alt="Kotlin" width={32} height={32} />,
  GoogleCloud: <Image src={googleCloudIcon} alt="Google Cloud" width={32} height={32} />,
  React: <Image src={reactIcon} alt="React" width={32} height={32} />,
  Tailwind: <Image src={tailwindIcon} alt="Tailwind" width={32} height={32} />,
  PostgreSQL: <Image src={postgresqlIcon} alt="PostgreSQL" width={32} height={32} />,
  };
