...
const sliderData = [
  ...
  },
  {
    ...
    content:
      "Desain antarmuka dengan pendekatan berpusat pada pengguna, mulai dari wireframe hingga prototipe.",
          ...
          <SwiperSlide key={item.title}>
            ...
            >
              ...
              <div className="relative z-20 p-6 flex flex-col items-start h-full justify-center text-center">
                ...
                <p
                  className="typo-b-lg text-neutral-100 drop-shadow-lg w-full mb-2 opacity-0 max-h-0 group-hover:opacity-100 group-hover:max-h-40 group-hover:translate-y-0 -translate-y-2 transition-all duration-500 overflow-hidden"
                >
                  {item.content}
                </p>
              </div>
