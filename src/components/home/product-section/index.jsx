...
function ProductSectionHeading() {
	...
	<section id="hero" className=" px-[20px] md:px-[80px] lg:px-[80px]">
		<div className="flex flex-col items-center justify-center text-center">
			<h1 className="typo-h1  leading-none bg-gradient-to-r from-[#EF9419] to-[#C94F1E] text-transparent bg-clip-text mt-10 py-5 md:py-6 lg:py-8 ">Solusi Inovatif FlyHigh</h1>
		</div>
	</section>
	);
}
...
function BetulinSection() {
	...
	<section className="py-12 md:py-16 lg:py-[60px]">
		...
		>
			...
			width={600}
			height={380}
			className={`absolute top-[10%] lg:top-1/8 left-[55%] lg:left-3/5 -translate-x-1/2 lg:-translate-y-1/2 transition-all duration-700 ease-out z-30 w-[180px] md:w-[320px] ${inView ? 'opacity-100' : 'opacity-0'}`}
		    />
		    <div className="relative w-full h-full pt-24 pb-8 md:pb-16">
			<Image
