  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 mx-4 my-4 flex-1 flex flex-col items-center text-center max-w-sm border border-gray-100 h-[480px]">
      ...
      <div className="mb-1 flex-1 flex">
        <p className="typo-b-sm text-neutral-700 leading-relaxed italic">
          {testimonial.quote}
        </p>
      </div>
    ...
    <section id="testimonials" className="relative py-20">
      <div className="relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-16">
          <h1 className="typo-h1 leading-none bg-gradient-to-r from-[#EF9419] to-[#C94F1E] text-transparent bg-clip-text mb-4">
            Bagaimana Ulasan Dari Mereka?
          </h1>
        </div>
        ...
        <div className="flex justify-center mt-16">
          <div className="w-24 h-1 bg-gradient-to-r from-[#EF9419] to-[#C94F1E] rounded-full"></div>
        </div>
      </div>
    </section>
  );
