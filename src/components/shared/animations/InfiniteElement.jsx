...
const useInfiniteAnimation = (baseVelocity, direction) => {
...
export function InfiniteElement({ children, baseVelocity = 10, className = "" }) {
...
export function ScrollInfiniteElement({ children, baseVelocity = 10, className = "" }) {
